...
/* je¿eli POTX/Y jest w³±czone ca³y czas ($dc00==$40), to nie ma problemu wcale
   je¿eli jest w³±czane np. na dwa cykle co ramkê to to kilku(nastu) sekundach
   uC zawiesza siê w stanie PA0=1, PA1=0, PA2=(chyba mruga jak ca³y czas)
   w tej chwili nie mo¿na powiedzieæ na 100% która to faza, nie wierzê w gubienie irq
   z timera
   UWAGA: przy tych próbach POTX by³ pod³±czony tylko do komparatora, byæ mo¿e
   bêdzie siê inaczej zachowywaæ przy sterowaniu nim równie¿ z portu z/bez pullupów
*/
